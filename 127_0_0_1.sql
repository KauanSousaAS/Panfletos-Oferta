...
--
-- Host: 127.0.0.1
-- Tempo de geração: 12/11/2024 às 14:45
...
--
ALTER TABLE `tb_preco`
  MODIFY `id_preco` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
('root', '[{\"db\":\"db_oferta\",\"table\":\"filial_produto\"},{\"db\":\"db_oferta\",\"table\":\"tb_filial\"},{\"db\":\"db_oferta\",\"table\":\"tb_produto\"},{\"db\":\"db_oferta\",\"table\":\"tb_preco\"}]');
...
('root', '2024-11-12 11:25:33', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt_BR\"}');
